"use strict";
// generated by running tsc and then copied so that can run in electron
...
var _a = require("unchained-bitcoin"), deriveChildPublicKey = _a.deriveChildPublicKey, blockExplorerAPIURL = _a.blockExplorerAPIURL, generateMultisigFromPublicKeys = _a.generateMultisigFromPublicKeys, bitcoinsToSatoshis = _a.bitcoinsToSatoshis;
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          currentAccountTotal = BigNumber(0);
      ...
      switch (_b.label) {
        ...
        case 3:
          ...
          for (i = 0; i < availableUtxos.length; i++) {
            ...
            availableUtxos[i].address = addressMap[availableUtxos[i].address].address; // TODO: this needs reworked
          }
          return [3 /*break*/, 6];
        case 4:
