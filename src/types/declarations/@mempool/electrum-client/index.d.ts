declare module "@mempool/electrum-client" {
  ...
  export type blockchainScripthash_getHistoryBatchResponse = {
    tx_hash: string;
    blockheight: number;
  };

  export type blockchainTransaction_getBatchResponse = {
    txid: string;
    hash: string;
    version: number;
    size: number;
  ...
  export type blockchainScripthash_listunspentBatch = {
    tx_hash: string;
    tx_pos: number;
    height: number;
  ...
  export default class ElectrumClient {
    ...
    initElectrum({ client: string, version: string });
    ...
    blockchainTransaction_get(txId: string, verbose: boolean): blockchainTransaction_getBatchResponse;
