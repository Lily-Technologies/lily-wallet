...
const PastePsbtModalContent = ({ closeModal, importTxFromFile, importTxFromFileError, setImportTxFromFileError }: Props) => {
      ...
      <div style={{ padding: '1.5em' }}>
        ...
        <ImportButtons>
          <FromFileButton
            ...
            onClick={() => onClickCloseModal()}>Cancel</FromFileButton>
          <ImportTxButton
            background={green600}
            color={white}
            onClick={() => { importTxFromFile(pastedPsbtValue) }}>
            Import Transaction
          </ImportTxButton>
        </ImportButtons>
      </div>
