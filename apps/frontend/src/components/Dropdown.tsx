        ...
        <ButtonContainer>
          {minimal ? (
            <button
              ...
              aria-label='Options'
              id='options-menu'
              className='flex items-center p-2 text-inherit cursor-pointer border-0 rounded-full focus:ring-green-500 focus:border-green-500 focus:outline-none hover:bg-gray-400/10 dark:hover:bg-white/10'
              ref={ref}
              {...rest}
            >
