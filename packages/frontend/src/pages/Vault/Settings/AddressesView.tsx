      ...
      <Table>
        <TableBody>
          {addresses.map((address) => (
            <AddressRow key={address.address} address={address} type='external' status='used' />
          ))}
          {unusedAddresses.map((address) => (
            <AddressRow key={address.address} address={address} type='external' status='unused' />
          ))}
          ...
          {unusedChangeAddresses.map((address) => (
            <AddressRow key={address.address} address={address} type='change' status='unused' />
          ))}
        </TableBody>
      </Table>
    </Padding>
