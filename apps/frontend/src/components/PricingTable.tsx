...
import { sm, md, lg } from 'src/utils/media';

import { LicenseTiers, LilyOnchainAccount } from '@lily/types';

interface Props {
  clickRenewLicense: (level: LicenseTiers, currentAccount: LilyOnchainAccount) => void;
        ...
        {!premiumOnly ? (
          <MobileTableItem>
            ...
            <MobileTable>
              ...
              <TableBody>
                <TableRow>
                  <TableHeader scope='row'>Single Signature Hardware Wallets</TableHeader>
                  <TableColumn>
                    <CheckIcon
                ...
                <TableRow>
                  <TableHeader scope='row'>
                    {twoOfThree ? '2-of-3' : threeOfFive ? '3-of-5' : 'Custom'} Multisig Vault
                  </TableHeader>
                  <TableColumn>
                    <CheckIcon
                      xmlns='http://www.w3.org/2000/svg'
        ...
        <DesktopTable>
          ...
          <thead>
            <TableRow>
              ...
              {!premiumOnly ? <DesktopTableHeader scope='col'>Basic</DesktopTableHeader> : null}
          ...
          <TableBody>
            <TableRow>
              <DesktopTablePricingHeader scope='row'>Pricing</DesktopTablePricingHeader>
            ...
            <TableRow>
              <DesktopKeyHeader scope='row'>Single Signature Hardware Wallets</DesktopKeyHeader>
              {!premiumOnly ? (
                <TableColumn>
                  <DesktopCheckIcon
                    xmlns='http://www.w3.org/2000/svg'
            ...
            <TableRow>
              <DesktopKeyHeader scope='row'>Connect to Bitcoin Core</DesktopKeyHeader>
              {!premiumOnly ? (
                <TableColumn>
                  <DesktopCheckIcon
                    xmlns='http://www.w3.org/2000/svg'
            ...
            <TableRow>
              <DesktopKeyHeader scope='row'>Phone / Zoom Support</DesktopKeyHeader>
              {!premiumOnly ? (
                <TableColumn>
                  <DesktopDashIcon
                    xmlns='http://www.w3.org/2000/svg'
