    ...
    >
      <div className='pt-5 pb-5 sm:px-0 sm:pt-0'>
        <div className='flex items-center justify-between'>
          <h3 className='font-medium text-gray-900 dark:text-slate-200'>Technical information</h3>
          <button
            type='button'
        ...
        <div className='overflow-hidden'>
          ...
          >
            <div className='mt-2 divide-y divide-gray-200 dark:divide-slate-700 border-t border-b border-gray-200 dark:border-slate-700'>
              <div className='flex flex-col py-5'>
                <dt className='text-sm font-medium text-gray-500 dark:text-slate-300 sm:flex-shrink-0'>
                  Extended Public Key (xpub)
                </dt>
                <dd className='mt-1 text-sm text-gray-900 dark:text-slate-200'>
                  <p className='break-all font-medium dark:text-slate-200'>
                    {extendedPublicKey.xpub}
                  </p>
                </dd>
              </div>
              <div className='flex justify-between font-medium py-5'>
                <dt className='text-sm font-medium text-gray-500 dark:text-slate-200 sm:w-40 sm:flex-shrink-0'>
                  Derivation path
                </dt>
              ...
              <div className='flex justify-between font-medium py-5'>
                <dt className='text-sm font-medium text-gray-500 dark:text-slate-300 sm:w-40 sm:flex-shrink-0'>
                  Fingerprint
                </dt>
                <dd className='mt-1 text-sm text-gray-900 dark:text-slate-200 sm:col-span-2 sm:mt-0'>
