...
import { DecoratedLightningChannel, LilyLightningAccount } from '@lily/types';
...
const CloseChannelSuccess = ({ channel, currentAccount }: Props) => (
  <Wrapper>
    ...
    <SuccessSubtext>You successfully closed your channel to {channel.alias}.</SuccessSubtext>
