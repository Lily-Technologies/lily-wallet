        ...
        <SentTxFormContainer data-cy="send-form">
            <InputContainer>
                <Textarea
                    ...
                    placeholder={""}
                    error={invoiceError}
            ...
            <SendButtonContainer>
                ...
                <ScanInvoiceFromQRButton
                    ...
                    onClick={() =>
                        openInModal(
                            <ScanLightningQrCode onSuccess={(data) => {
