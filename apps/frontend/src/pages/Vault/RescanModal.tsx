...
import { StyledIcon, Input, Button, Spinner, ModalContentWrapper } from 'src/components';

import { mobile } from 'src/utils/media';
import { white, green600, red100, gray400, gray700, gray500, gray900 } from 'src/utils/colors';
